...
def main(args):
    ...
    if args.set == "random":
        questions_file = open(os.path.join(args.pope_path, "coco_pope_random.json"), "r")
    elif args.set == "popular":
        questions_file = open(os.path.join(args.pope_path, "coco_pope_popular.json"), "r")
    elif args.set == "adv":
        questions_file = open(os.path.join(args.pope_path, "coco_pope_adversarial.json"), "r")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="./src/pope_result/")
